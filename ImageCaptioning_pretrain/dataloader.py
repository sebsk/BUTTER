...
class DataLoader(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        # MODIFIED
        # if self.opt.pretrained_rnn:
        #     dec_params = torch.load(opt.pretrained_rnn)
        #     self.ix_to_word = dec_params['vocab']['id2word']
        #     self.ix_to_word[3] = 'UNK' # consistent with prepro_labels.py
        #     self.vocab_size = len(self.ix_to_word) - 1
        # else:
