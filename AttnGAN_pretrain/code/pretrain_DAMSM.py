...
def parse_args():
    ...
    parser.add_argument('--pretrained-rnn', dest='pretrained_rnn', type=str,
                        help='pretrained rnn encoder', default='')
...
def build_models():
    ...
    if cfg.PRETRAINED_RNN:
        text_encoder_params = torch.load(cfg.PRETRAINED_RNN, map_location=lambda storage, loc: storage)
...
if __name__ == "__main__":
    ...
    if args.pretrained_rnn:
        cfg.PRETRAINED_RNN = args.pretrained_rnn
